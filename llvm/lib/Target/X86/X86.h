...
void initializeX86PrivExecBrSanitizerPass(PassRegistry &);
void initializeX86PrivExecLSSanitizerPass(PassRegistry &);
void initializeX86PrivExecBrPostRegsSanitizerPass(PassRegistry &);
